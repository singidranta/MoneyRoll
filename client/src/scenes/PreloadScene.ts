...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image('hotdog', '/assets/props/flat/food/hotdog.png');
    this.load.image('sushi', '/assets/props/flat/food/sushi.png');
    this.load.image('pizza', '/assets/props/flat/food/pizza.png');
    this.load.image('salad', '/assets/props/flat/food/salad.png');
    this.load.image('ramen', '/assets/props/flat/food/ramen.png');
    this.load.image('steak', '/assets/props/flat/food/steak.png');
    this.load.image('jacket', '/assets/props/flat/clothing/adidas-jacket.webp');
